...
tags: [docker]
---
У Docker Hub есть [лимиты](https://docs.docker.com/docker-hub/download-rate-limit/) на выкачивание образов. Значение по умолчанию — 100 загрузок за 6 часов. Маловероятно, конечно, что будет столько закачек, но если нет авторизации и выделенного IP, то исчерпать лимит возможно.
