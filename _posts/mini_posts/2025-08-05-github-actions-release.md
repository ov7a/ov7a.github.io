...
Главное — выбрать правильно action :) [Официальное](https://github.com/actions/create-release) — в архиве, одно из 4 рекомендованных — тоже, еще 2 имеют странные настройки по умолчанию, и методом исключения было выбрано [softprops/action-gh-release](https://github.com/softprops/action-gh-release).
