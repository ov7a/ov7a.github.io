...
Понятно, что если приложение полностью под контролем, проще его пересобрать, а что-то мелкое можно и через консоль протестировать. Однако если код не полностью под контролем (например, он сгенерирован каким-то экзотическим языком) и/или как-то нестандартно связан с другими модулями — так может быть проще.
