...
- если в коде лашпа if-ов вместо паттерн-матчинга или switch, или массив сортируется только ради того, чтобы взять первый элемент как максимальный — это, очевидно, не в языке проблема.
